            ...
            <>
              ...
              <div className="grid lg:grid-cols-3 md:gap-8">
                <div className="lg:col-span-1">
                  <div
                    className=" hidden md:inline-block w-full bg-white p-6 rounded-md
               border"
                  >
                    ...
                    <div className="space-y-4 py-5 flex flex-col items-center">
                      ...
                      >
                        {isLoading ? (
                          <div className="flex items-center justify-center gap-x-5 w-full text-base">
                            <p>Processing...</p>
                      ...
                      <Link
                        href={"/"}
                        className="text-base font-semibold hover:underline hover:text-blue-400 duration-300"
                      >
                        Continue Shopping
                      </Link>
                    </div>
                ...
                <div className="lg:col-span-2 pb-5">
                  <div
                    className="grid grid-cols-5 md:grid-cols-6 border p-2.5 rounded-tr-lg rounded-tl-lg
                      ...
                      return (
                        ...
                        >
                          <div className="col-span-2 md:col-span-3 flex items-center gap-2">
                            <Trash2
                              className="cursor-pointer hover:text-red-600 duration-300 ease-in-out"
                              onClick={() => {
                            ...
                            <PriceFormatter
                              amount={
                                product.product.price
                                  ? product.product.price * itemCount
                                  : 0
                              }
                            />
                          </div>
